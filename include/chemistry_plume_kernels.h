        ...
        for (int k=kstart; k<kend; ++k)
        {
            ...
            for (int j=jstart; j<jend; ++j)
                ...
                for (int i=istart; i<iend; ++i)
                {
                    ...
                    // especially for NO2-focused chemistry because HO2 and RO2 directly affect NO -> NO2 conversion.
                    ...
                    TF fix_oh = p_oh0 / std::max(l_oh0, eps_qssa);
                    ...
                    TF fix_ro2 = p_ro20 / std::max(l_ro20, eps_qssa);
                    ...
                    TF fix_ho2 = p_ho20 / std::max(l_ho20, eps_qssa);
                    ...
                    TF fix_no3 = p_no30 / std::max(l_no30, eps_qssa);
                    ...
                    TF fix_n2o5 = p_n2o50 / std::max(l_n2o50, eps_qssa);

                    // =========================================================================
                    // QSSA Iteration: Solve P = L * F for OH, HO2, RO2, NO3, N2O5
                    // =========================================================================
                    for (int i_qssa=0; i_qssa<15; i_qssa++)
                    {
                        // ---------------------------------------------------------------------
                        ...
                        p_no3 = rconst7*var_no2*var_o3                 // RF[7]: NO2(V6) + O3(V7)
                              ...
                              + jval[Jval::n2o5]*fix_n2o5;             // RF[31]: N2O5(F7)
